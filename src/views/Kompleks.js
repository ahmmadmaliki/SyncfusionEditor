            ...
            blocks: [
              ...
              },
              {
                ...
                inlines: [
                  ...
                  { characterFormat: {}, text: 'AdventureWorks' },
                  { characterFormat: {}, text: ' sample databases ' },
                  {
                    characterFormat: {},
                    text:
                      'are based, is a large, multinational manufacturing company. The company manufactures and sells metal ',
                  },
                  {
                    characterFormat: {},
                    text:
                      'and composite bicycles to North American, European and Asian commercial markets. While its base ',
                  },
                  { characterFormat: {}, text: 'operation ' },
                  { characterFormat: {}, text: 'is located in' },
                  {
                    characterFormat: {},
                    text:
              ...
              },
              {
                ...
                inlines: [
                  ...
                  { characterFormat: {}, text: 'Importadores' },
                  { characterFormat: {}, text: ' Neptuno, ' },
                  { characterFormat: {}, text: 'located in Mexico. ' },
                  { characterFormat: {}, text: 'Importadores' },
                  {
                    characterFormat: {},
                    text:
                      ' Neptuno manufactures several critical subcomponents for the ',
                  },
                  {
                    characterFormat: {},
                    text:
                      'Adventure Works Cycles product line. These subcomponents are shipped to the Bothell location for final ',
                  },
                  { characterFormat: {}, text: 'product assembly. In 2001, ' },
                  { characterFormat: {}, text: 'Importadores' },
                  {
                    characterFormat: {},
                    text:
                      ' Neptuno, became the sole manufacturer and distributor of the ',
                  },
                  {
                    characterFormat: {},
              ...
              },
              {
                ...
                characterFormat: {},
                inlines: [{ characterFormat: {}, text: 'Product Overview' }],
              },
              {
                rows: [
                  {
                      ...
                      },
                      {
                        blocks: [
                          ...
                          },
                          {
                            ...
                            characterFormat: {},
                            inlines: [
                              { characterFormat: {}, text: 'Weight: 25' },
                            ],
                          },
                          {
                            paragraphFormat: {
                            ...
                            characterFormat: {},
                            inlines: [
                              { characterFormat: {}, text: 'Price: $2,294.99' },
                            ],
                          },
                          {
                            paragraphFormat: {
                        ...
                        blocks: [
                          {
                            ...
                            characterFormat: {},
                            inlines: [
                              { characterFormat: {}, text: 'Mountain-300' },
                            ],
                          },
                          {
                            paragraphFormat: {
                          ...
                          },
                          {
                            ...
                            characterFormat: {},
                            inlines: [
                              { characterFormat: {}, text: 'Weight: 22' },
                            ],
                          },
                          {
                            paragraphFormat: {
                            ...
                            characterFormat: {},
                            inlines: [
                              { characterFormat: {}, text: 'Price: $1,079.99' },
                            ],
                          },
                          {
                            paragraphFormat: {
                      ...
                      },
                      {
                        blocks: [
                          ...
                          },
                          {
                            ...
                            characterFormat: {},
                            inlines: [
                              { characterFormat: {}, text: 'Weight: 14' },
                            ],
                          },
                          {
                            paragraphFormat: {
                            ...
                            characterFormat: {},
                            inlines: [
                              { characterFormat: {}, text: 'Price: $3,578.27' },
                            ],
                          },
                          {
                            paragraphFormat: {
